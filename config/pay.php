...
return [
    'alipay' => [
        'default' => [
            ...
            // 应用公钥证书 路径
            'app_public_cert_path' => storage_path('app/pay/alipay/appCertPublicKey_2021000117601830.crt'),
            // 支付宝公钥证书 路径
            'alipay_public_cert_path' => storage_path('app/pay/alipay/alipayCertPublicKey_RSA2.crt'),
            // 支付宝根证书 路径
